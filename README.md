# О проекте
Прототип квест игры. Представляет собой простую линейную диалоговую систему, которая основа на графе - вершины - описание сцены, ребра - варианты выбора действий для перехода к следующей сцене.
